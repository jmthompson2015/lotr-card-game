...
define(["common/js/InputValidator", "artifact/js/AllyCard", "artifact/js/AttachmentCard", "artifact/js/CardSet", "artifact/js/EventCard", "artifact/js/HeroCard", "artifact/js/Sphere", "model/js/CardInstance"],
   function(InputValidator, AllyCard, AttachmentCard, CardSet, EventCard, HeroCard, Sphere, CardInstance)
   {
      var DeckBuilders = [];
