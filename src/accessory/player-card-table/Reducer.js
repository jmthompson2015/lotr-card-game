...
define(["common/js/InputValidator", "accessory/player-card-table/Action", "accessory/player-card-table/DefaultFilters", "accessory/player-card-table/InitialState"],
