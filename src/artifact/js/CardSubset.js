...
define(["artifact/js/CardSet", "artifact/js/CardSetType"],
   function(CardSet, CardSetType)
   {
      var CardSubset = {
      ...
      CardSubset.keys().forEach(function(cardKey)
      {
