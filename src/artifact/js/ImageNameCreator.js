...
define(["common/js/InputValidator", "artifact/js/CardSet", "artifact/js/CardSubset", "artifact/js/CardType"],
   function(InputValidator, CardSet, CardSubset, CardType)
   {
         ...
         create: function(card)
         {
            ...
            else
            {
               ...
               if (!cardSet)
               {
                  ...
                  if (!encounterSet)
                  {
                     throw "Can't find encounter set for card: " + card.name;
                  }
               ...
               var description, cardSubsetName;
               ...
               {
                  cardSubsetName = this.convert(cardSubset.name);
