...
define(["create-react-class", "prop-types", "react-dom-factories", "common/js/InputValidator"],
   ...
   {
      var HeroCardImage = createReactClass(
      {
         render: function()
         {
         ...
         createSrc: function(card)
         {
            ...
            return HeroCardImage.BASE_URL + cardSetUrl + cardUrl + ".jpg";
         },
      ...
      HeroCardImage.propTypes = {
         card: PropTypes.object.isRequired,

         width: PropTypes.number,
      };

      HeroCardImage.defaultProps = {
         width: 422,
      };

      HeroCardImage.BASE_URL = "https://s3.amazonaws.com/hallofbeorn-resources/Images/Cards/";
