...
define(["create-react-class", "prop-types", "react-dom-factories", "common/js/InputValidator"],
   ...
   {
      var EnemyCardImage = createReactClass(
      {
         render: function()
         {
         ...
         createSrc: function(card)
         {
            ...
            return EnemyCardImage.BASE_URL + cardSetUrl + cardUrl + ".jpg";
         },
         ...
         logLoadFailure: function(src)
         {
            ...
            LOGGER.error("EnemyCardImage failed to load " + filename);
         },
      });

      EnemyCardImage.propTypes = {
         card: PropTypes.object.isRequired,

         width: PropTypes.number,
      };

      EnemyCardImage.defaultProps = {
         width: 422,
      };

      EnemyCardImage.BASE_URL = "https://s3.amazonaws.com/hallofbeorn-resources/Images/Cards/";
