...
define(["create-react-class", "prop-types", "react-dom-factories", "common/js/InputValidator"],
   ...
   {
      var ObjectiveCardImage = createReactClass(
      {
         render: function()
         {
         ...
         createSrc: function(card)
         {
            ...
            return ObjectiveCardImage.BASE_URL + cardSetUrl + cardUrl + ".jpg";
         },
         ...
         logLoadFailure: function(src)
         {
            ...
            LOGGER.error("ObjectiveCardImage failed to load " + filename);
         },
      });

      ObjectiveCardImage.propTypes = {
         card: PropTypes.object.isRequired,

         width: PropTypes.number,
      };

      ObjectiveCardImage.defaultProps = {
         width: 422,
      };

      ObjectiveCardImage.BASE_URL = "https://s3.amazonaws.com/hallofbeorn-resources/Images/Cards/";

      return ObjectiveCardImage;
   });
