...
define(["qunit", "artifact/js/AllyCard", "artifact/js/AttachmentCard", "artifact/js/EnemyCard", "artifact/js/EventCard", "artifact/js/HeroCard", "artifact/js/LocationCard", "artifact/js/QuestCard", "artifact/js/ImageNameCreator"],
   function(QUnit, AllyCard, AttachmentCard, EnemyCard, EventCard, HeroCard, LocationCard, QuestCard, ImageNameCreator)
   {
      ...
      QUnit.test("create() allies", function(assert)
      {
         ...
         assert.equal(ImageNameCreator.create(AllyCard.properties[AllyCard.BLUE_MOUNTAIN_TRADER]),
            "http://www.cardgamedb.com/forums/uploads/lotr/ffg_blue-mountain-trader-the-ring-maker.jpg");
         assert.equal(ImageNameCreator.create(AllyCard.properties[AllyCard.GALADHRIM_MINSTREL]),
            "http://www.cardgamedb.com/forums/uploads/lotr/ffg_galadhrim-minstrel-the-ring-maker.jpg");
         assert.equal(ImageNameCreator.create(AllyCard.properties[AllyCard.GREYFLOOD_WANDERER]),
            "http://www.cardgamedb.com/forums/uploads/lotr/ffg_greyflood-wanderer-the-ring-maker.jpg");
         assert.equal(ImageNameCreator.create(AllyCard.properties[AllyCard.BARLIMAN_BUTTERBUR]),
            "http://www.cardgamedb.com/forums/uploads/lotr/ffg_barliman-butterbur-tbr.jpg");
         assert.equal(ImageNameCreator.create(AllyCard.properties[AllyCard.BILBO_BAGGINS]),
            "http://www.cardgamedb.com/forums/uploads/lotr/ffg_MEC34_006.jpg");
         assert.equal(ImageNameCreator.create(AllyCard.properties[AllyCard.ANBORN_TLOS]),
      ...
      QUnit.test("create() quests", function(assert)
      {
         assert.equal(ImageNameCreator.create(QuestCard.properties[QuestCard.PTM1A_FLIES_AND_SPIDERS]),
            "http://s3.amazonaws.com/hallofbeorn-resources/Images/Cards/Core-Set/Flies-and-Spiders-1A.png");
         assert.equal(ImageNameCreator.create(QuestCard.properties[QuestCard.PTM1B_FLIES_AND_SPIDERS]),
            "http://s3.amazonaws.com/hallofbeorn-resources/Images/Cards/Core-Set/Flies-and-Spiders-1B.png");
         assert.equal(ImageNameCreator.create(QuestCard.properties[QuestCard.THFG1A_THE_HUNT_BEGINS]),
            "http://s3.amazonaws.com/hallofbeorn-resources/Images/Cards/The-Hunt-for-Gollum/The-Hunt-Begins-1A.png");
         assert.equal(ImageNameCreator.create(QuestCard.properties[QuestCard.THFG1B_THE_HUNT_BEGINS]),
